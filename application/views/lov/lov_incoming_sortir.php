    ...
    <div class="modal-dialog" style="width:1000px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <thead>
                  <tr>
                     <th data-column-id="in_biz_det_id" data-sortable="false" data-visible="false">ID Produk</th>
        ...
        $("#modal_lov_stock_material_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_lov_stock_material_set_value(\''+ row.in_biz_det_id +'\', \''+ row.packing_batch_number +'\', \''+ row.product_id +'\', \''+ row.product_code +'\', \''+ row.qty_netto +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                }
             },
             rowCount:[5,10],
             ajax: true,
             ...
             url: '<?php echo WS_BOOTGRID."agripro.sortir_bizhub_controller/readLovIncoming"; ?>',
             selection: true,
             sorting:true
        });
