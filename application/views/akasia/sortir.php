...
<?php $this->load->view('lov/lov_incoming_sortir.php'); ?>
...
<script>
		...
		if( $("#tgl_produksi").val().length > 0 ){
			...
			if (rowid != null) {
				grid_detail.jqGrid('setGridParam', {
					url: '<?php echo WS_JQGRID . "agripro.sortir_bizhub_controller/crud"; ?>',
    ...
    function get_availableqty() {
			...
			$.ajax({
				url: "<?php echo WS_JQGRID . 'agripro.sortir_bizhub_controller/get_availableqty_detail'; ?>",
				type: "POST",
				dataType: 'json',
				data: {in_biz_det_id: sm_id, sortir_bizhub_id:sortir_id},
    ...
    jQuery(function ($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Transaction Code', name: 'packing_batch_number', width: 350, align: "left", editable: false, editoptions: { size: 25}},
                {
            ...
            onSelectRow: function (rowid) {
				...
				var sm_id = $('#grid-table').jqGrid('getCell', rowid, 'in_biz_det_id');
            ...
            editurl: '<?php echo WS_JQGRID . "agripro.sortir_bizhub_controller/crud"; ?>',
        ...
        jQuery("#grid-table-detail").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Product Code', name: 'product_code', width: 150, align: "left", editable: false},
                {
                    ...
                    editoptions: {
                        dataUrl: '<?php echo WS_JQGRID . "agripro.sortir_bizhub_controller/list_product"; ?>',
                        postData: {
                            product_id: function () {
