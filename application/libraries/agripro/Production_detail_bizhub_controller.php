...
*/
class Production_detail_bizhub_controller {

    function read() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','production_bizhub_det_id');
        $sord = getVarClean('sord','str','desc');

        $data = array('rows' => array(), 'page' => 1, 'records' => 0, 'total' => 1, 'success' => false, 'message' => '');
        $production_id = getVarClean('production_bizhub_id','int',0);
        ...
        try {
            ...
            $table = $ci->production_detail_bizhub;
            ...
            // Filter Table
            $req_param['where'] = array('pd.production_bizhub_id = '.$production_id);
